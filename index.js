...
reviews.push({ name: "John", rating: 1, feedback: 0 "garbage"});
...
*/
function getReviewByIndex(input) {

  return `The patron, ${reviews[input].name}, gave this restaurant a rating of ${reviews[input].rating}. Their review is: ${reviews[input].feedback}`
}
